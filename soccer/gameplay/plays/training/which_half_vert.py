...
class WhichHalfVert(play.Play):
    ...
    def __init__(self):
        ...
        # eg: self.add_state(WhichHalfVert.State.<???>,
        #                    behavior.Behavior.State.running)
        # ----------------------------------------------------

        # Assume we're either in tophalf or bottomhalf, no state for
        # being right on the line.
        self.add_state(WhichHalfVert.State.lefthalf,
                       behavior.Behavior.State.running)
        self.add_state(WhichHalfVert.State.righthalf,
                       behavior.Behavior.State.running)
